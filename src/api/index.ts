...
export { buyForMeApi } from './buyForMe'
...
export { disputesAdminApi, disputesUserApi } from './disputes'
export { pharmacyApi } from './pharmacy'
export { discoveryApi } from './discovery'
export { promotionsApi, promotionsAdminApi } from './promotions'
...
export { premiumAdminApi, premiumUserApi } from './premium'
