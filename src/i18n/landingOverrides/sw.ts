/** Swahili landing copy aligned with buyers/sellers copy deck (2026). */
export default {
  landing: {
    navWork: 'Uandikishaji',
    navOnboarding: 'Uandikishaji',
    navDownload: 'Pakua — bure',
    heroEyebrow: 'Kwa wanunuzi · Kwa wauzaji',
    heroHeadlineSell: 'Uza',
    heroHeadlineBuy: 'Nunua',
    heroHeadlineAnd: '&',
    heroHeadlineGo: 'ENDELEA',
    heroHeadline1: 'Uza, Nunua & ENDELEA',
    heroHeadline2: 'katika mfumo mmoja unaoaminika',
    heroBigWords: 'Nunua. Uza.',
    heroAccentWord: '',
    ...
    heroTrustLine:
      'Hakuna kadi · M-Pesa, Airtel Money au Tigo Pesa · Pesa yako imelindwa hadi uthibitisho wa usafirishaji',
    ...
    influencerStep3Desc:
      'Ona ulichopata na lini malipo yanafika. Pesa kwa simu au benki—njia ambayo watu wako tayari wanatumia.',
    influencerFeature1: 'Kiungo chako na mibofyo inayofuatiliwa',
    influencerFeature2: 'Kamisheni kwa usajili na maagizo',
    influencerFeature3: 'Malipo kwa simu au benki',
    influencerPerk1Title: 'Kiungo chako, hadhira yako',
    influencerPerk1Desc:
      'Kila mguso na agizo huhesabiwa kwako—si kupotea kwenye dashibodi ya mtu mwingine.',
    influencerPerk2Title: 'Mapato unayoiona',
    influencerPerk2Desc:
      'Kamisheni inasasishwa watu wanapojiunga na kununua. Daima ujue unachostahili.',
    influencerPerk3Title: 'Malipo kwa njia ya ndani',
    influencerPerk3Desc:
    ...
    sellerTier2Desc:
      'Kitambulisho kimehakikiwa. Beji ya uthibitisho kwenye duka lako ili wanunuzi wajue unayelipwa.',
    sellerTier3Level: 'Kiwango 3',
    sellerTier3Name: 'Unayependelewa',
    sellerTier3Desc:
      'Ukadiriaji mzuri na utoaji kwa wakati. Viwango bora vya kamisheni na wapiga mbio wa kipaumbele.',
    sellerTier4Level: 'Kiwango 4',
    sellerTier4Name: 'Mshirika',
    sellerTier4Desc:
      'Muuzaji bora. Onyesho katika utafutaji, msaada wa ukuaji, na usuluhishi wa haraka wa migogoro.',
    ...
    buyerFeature3Title: 'Bidhaa, chakula, mboga',
    buyerFeature3Desc:
      'Kutoka mgahawa Kinondoni hadi duka Kariakoo — programu moja, malipo moja, dhamana moja. Hakuna kubadilisha programu.',
    buyerFeature4Title: 'Kila agizo linakupa thamani',
    buyerFeature4Desc:
      'XP, mfululizo, viwango, kadi za bahati, ubao wa watazamaji. Kila ununuzi unakuletea punguzo, usafirishaji bure na mauzo ya haraka.',
    buyerFeature5Title: 'Mauzo ya haraka na agizo la pamoja',
    buyerFeature5Desc:
      'Mauzo ya wanachama pekee na agizo la pamoja na marafiki — watu wengi, bei bora. Programu inaratibu.',
    buyerFeature6Title: 'Lipa jinsi Afrika Mashariki inavyolipa',
    buyerFeature6Desc:
      'M-Pesa, Airtel Money, Tigo Pesa. Hakuna kadi wala ada za ubadilishaji. Pesa ya simu unayotumia — sasa imelindwa.',
    ...
    sellerFeature3Title: 'Takwimu zinazosema ukweli',
    sellerFeature3Desc:
      'Bidhaa zinazouzwa, wateja wanaorudi, kilele chako, faida yako — data halisi kwenye simu.',
    sellerFeature4Title: 'CRM, deni na ankara',
    sellerFeature4Desc:
      'Kila mnunuzi kwenye rekodi yako — historia, salio, agizo la mwisho. Ankara kutoka simu. Acha daftari.',
    sellerFeature5Title: 'Hifadhi chini ya udhibiti',
    sellerFeature5Desc:
    ...
    ifYouRideBody: 'Kila agizo linapitia mfumo wa ulinzi uliotengenezwa kwa miji ya Afrika Mashariki.',
    ifYouRideCta: 'Nunua kwa ujasiri',
    ...
    ecosystemCard1Desc:
      'Matumizi zaidi, zawadi zaidi. Zawadi bora zinawaleta tena.',
    ecosystemCard2Title: 'Kwa wauzaji',
    ecosystemCard2Desc:
    ...
    testimonialsCallout: 'Agizo lako la kwanza linalindwa tangu unapolipa.',
    ...
    testimonial2Text:
      'Mara ya kwanza nikanunua mtandaoni kwa mtu nisiyemfahamu bila wasiwasi. Bidhaa mbaya? Badiliko alasiri. Hakuna ugomvi.',
    testimonial3Name: 'Fatuma M.',
    testimonial3Role: 'Msasani · msimamizi wa ofisi',
    testimonial3Text:
    ...
    testimonial4Text:
      'Duka, usafirishaji, dashibodi — mapato yanaongezeka na kwa mara ya kwanza naelewa kwa nini.',
    testimonial5Name: 'Grace N.',
    testimonial5Role: 'Mboga Kinondoni · Muuzaji trusted',
    testimonial5Text:
      'Takwimu zilibadilisha kila kitu. Najua kilichouzwa, lini, na faida gani. Napoteza kidogo, napata zaidi.',
    testimonial6Name: 'Mama Zawadi',
    testimonial6Role: 'Chakula cha nyumbani · Muuzaji verified',
    testimonial6Text:
      'Napika. Jukwaa linashughulikia mengine. Wateja wangu bado wapo — sasa wanaagiza vizuri.',
    footerTagline: 'Nunua kwa ujasiri. Uza kwa mpangilio.',
    footerTaglineMain: 'Biashara ya Afrika Mashariki, hatimaye imehakikishwa.',
    footerTaglineSub:
