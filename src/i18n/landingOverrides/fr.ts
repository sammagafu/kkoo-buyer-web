/** French landing copy aligned with buyers/sellers copy deck (2026). */
export default {
  landing: {
    navWork: 'Intégration',
    navOnboarding: 'Intégration',
    navDownload: 'Télécharger — gratuit',
    heroEyebrow: 'Pour les acheteurs · Pour les vendeurs',
    heroHeadlineSell: 'Vendez',
    heroHeadlineBuy: 'Achetez',
    heroHeadlineAnd: '&',
    heroHeadlineGo: 'GO',
    heroHeadline1: 'Vendez, Achetez & GO',
    heroHeadline2: 'dans un écosystème de confiance unique',
    heroBigWords: 'Achetez. Vendez.',
    heroAccentWord: '',
    ...
    heroTrustLine:
      "Sans carte · M-Pesa, Airtel Money ou Tigo Pesa · Votre argent est protégé jusqu'à confirmation de livraison",
    ...
    influencerStep3Desc:
      'Voyez ce que vous avez gagné et quand le paiement arrive. Mobile money ou banque—comme votre audience paie déjà.',
    influencerFeature1: 'Lien perso et clics suivis',
    influencerFeature2: 'Commission inscriptions et commandes',
    influencerFeature3: 'Paiement mobile ou banque',
    influencerPerk1Title: 'Votre lien, votre audience',
    influencerPerk1Desc:
      'Chaque clic et commande compte pour vous—pas perdus dans le tableau de bord d’un autre.',
    influencerPerk2Title: 'Des gains visibles',
    influencerPerk2Desc:
      'Les commissions se mettent à jour quand les gens rejoignent et achètent. Vous savez toujours ce qui vous est dû.',
    influencerPerk3Title: 'Payé à la locale',
    influencerPerk3Desc:
    ...
    sellerTier2Desc:
      'Identité confirmée. Badge vérifié pour que les acheteurs sachent à qui ils paient.',
    sellerTier3Level: 'Niveau 3',
    sellerTier3Name: 'Préféré',
    sellerTier3Desc:
      'Bonnes notes et livraisons à l’heure. Meilleurs taux de commission et livreurs prioritaires.',
    sellerTier4Level: 'Niveau 4',
    sellerTier4Name: 'Partenaire',
    sellerTier4Desc:
      'Vendeur top. Mise en avant dans la recherche, support dédié et litiges traités en priorité.',
    ...
    buyerFeature3Title: 'Produits, restauration, courses',
    buyerFeature3Desc:
      'Du restaurant à Kinondoni aux courses à Kariakoo — une app, un paiement, une garantie. Sans changer d\'app ni ressaisir votre adresse.',
    buyerFeature4Title: 'Chaque commande vous rapporte',
    buyerFeature4Desc:
      'XP, séries, niveaux, cartes à gratter, classements. Chaque achat rapproche remises exclusives, livraison gratuite et ventes flash.',
    buyerFeature5Title: 'Ventes flash et commandes groupées',
    buyerFeature5Desc:
      'Ventes flash réservées aux membres et commandes groupées entre amis ou voisins — plus vous êtes nombreux, meilleur est le prix.',
    buyerFeature6Title: 'Payez comme l\'Afrique de l\'Est paie',
    buyerFeature6Desc:
      'M-Pesa, Airtel Money, Tigo Pesa. Pas de carte ni de frais de conversion. L\'argent mobile que vous utilisez déjà — enfin protégé.',
    ...
    sellerFeature3Title: 'Des analyses qui parlent vrai',
    sellerFeature3Desc:
      'Quels produits partent, quels clients reviennent, vos pics, vos marges — des données réelles sur votre téléphone.',
    sellerFeature4Title: 'CRM, créances et factures',
    sellerFeature4Desc:
      'Chaque acheteur dans votre dossier — historique, solde, dernière commande. Factures depuis le téléphone. Fini le carnet.',
    sellerFeature5Title: 'Stock sous contrôle',
    sellerFeature5Desc:
    ...
    ifYouRideBody: 'Chaque commande passe par une protection pensée pour le commerce en ville en Afrique de l\'Est.',
    ifYouRideCta: 'Acheter en confiance',
    ...
    ecosystemCard1Desc:
      'Plus vous utilisez, plus vous gagnez. Mieux vous êtes récompensé, plus vous revenez.',
    ecosystemCard2Title: 'Pour les vendeurs',
    ecosystemCard2Desc:
    ...
    testimonialsCallout: 'Votre première commande est protégée dès le paiement.',
    ...
    testimonial2Text:
      "Première fois que j'achète en ligne à un inconnu sans stress. Article erroné ? Remplacé l'après-midi. Sans dispute.",
    testimonial3Name: 'Fatuma M.',
    testimonial3Role: 'Msasani · office manager',
    testimonial3Text:
      'Commandes groupées, meilleurs prix, points à chaque fois. En décembre, un mois de livraison gratuite — de l\'argent réel.',
    ...
    testimonial4Text:
      'Vitrine, livraison, tableau de bord — le chiffre monte et je comprends enfin pourquoi.',
    testimonial5Name: 'Grace N.',
    testimonial5Role: 'Épicerie Kinondoni · Vendeuse fiable',
    testimonial5Text:
      'Les analyses ont tout changé. Je sais quoi a vendu, quand, et quelle marge. Moins de gaspillage, plus de gain.',
    testimonial6Name: 'Mama Zawadi',
    testimonial6Role: 'Cuisine maison · Vendeuse vérifiée',
    testimonial6Text:
      'Je cuisine. La plateforme gère le reste. Mes habitués commandent proprement maintenant.',
    footerTagline: 'Achetez en confiance. Vendez avec structure.',
    footerTaglineMain: 'Le commerce d\'Afrique de l\'Est, enfin garanti.',
    footerTaglineSub:
