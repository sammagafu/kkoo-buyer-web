    ...
    <b-card class="mb-4" header="Customer experiences" header-bg-variant="light" header-class="fw-semibold">
      <b-row class="g-3">
        <b-col v-for="app in frontendApps" :key="app.title" cols="12" sm="6" xl="4">
          <router-link :to="app.to" class="text-decoration-none text-reset d-block h-100">
...
const frontendApps = computed(() => [
  { title: 'Marketplace', icon: 'solar:cart-large-2-bold', badge: 'Buyer', to: { name: 'buyer.marketplace' } },
...
const workspaceCards = computed(() => [
  ...
  },
  {
    ...
    route: roleAvailability.value.has(ROLES.CRM_MEMBER) ? undefined : null,
