  ...
  <div class="store-preview">
    <div class="store-preview-bar d-flex align-items-center justify-content-between gap-2 px-3 py-2 bg-light border-bottom">
      <div class="d-flex align-items-center gap-2">
        <a v-if="typeof backTo === 'string'" :href="backTo" class="btn btn-sm btn-outline-secondary">← Back</a>
        <router-link v-else :to="backTo" class="btn btn-sm btn-outline-secondary">← Back</router-link>
...
const backTo = computed(() => {
  ...
  return adminWebPath('/admin/sellers')
})
</script>
