...
export const creatorPerks = [
  { key: 'commission', icon: 'solar:wallet-money-bold', titleKey: 'landing.premium.creatorPerk1Title', descKey: 'landing.premium.creatorPerk1Desc' },
  { key: 'link', icon: 'solar:link-bold', titleKey: 'landing.premium.creatorPerk2Title', descKey: 'landing.premium.creatorPerk2Desc' },
  { key: 'dashboard', icon: 'solar:chart-2-bold', titleKey: 'landing.premium.creatorPerk3Title', descKey: 'landing.premium.creatorPerk3Desc' },
] as const
